...
class App extends React.Component {
    constructor(props) {
        ...
        this.audioPlayer = new AudioPlayer({
            ...
            pitchSemitones: this.state.pitch,
    ...
    handlePitchChange(e) {
        const pitchSemitones = parseInt(e.target.value, 10);
        this.audioPlayer.pitchSemitones = pitchSemitones;
        this.setState({ pitch: pitchSemitones });
    }
            ...
            <div className="container" style={{marginTop: '1em'}}>
                ...
                <div className="row">
                    <div className="col-xs-5 col-sm-3 col-lg-2" style={{paddingTop: '7px'}}>
                        Pitch ({this.state.pitch > 0 ? '+' : ''}{this.state.pitch})
                    </div>
                    <div className="col-xs-7 col-sm-9 col-lg-10">
                        <input
                            className="form-control"
